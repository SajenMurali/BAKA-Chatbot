...
BAKA is a simple offline/online Python voice assistant that can detect system info, tell jokes, switch voices, and search online when connected to the internet.
